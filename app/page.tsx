  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-24 bg-zinc-50 dark:bg-black font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
        ...
        <div className="rounded-lg border border-transparent px-5 py-4 flex items-center justify-center border-dashed border-2 border-gray-300 dark:border-neutral-800">
